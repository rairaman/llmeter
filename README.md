...
`5h` is the rolling 5-hour session window (the one you hit mid-afternoon) and `wk` the weekly plan. The 5-hour reset always lands today, so it shows the clock time alone; the weekly one carries its weekday.
